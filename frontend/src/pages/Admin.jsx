...
function Admin() {
  ...
  useEffect(() => {
    if (authenticated) {
      const socket = io('https://lost-and-gain-backend.onrender.com');
  ...
  const fetchAllData = async () => {
    ...
    try {
      const [postsRes, usersRes, msgsRes, claimRes] = await Promise.all([
        axios.get('https://lost-and-gain-backend.onrender.com/api/materials/admin/posts'),
        axios.get('https://lost-and-gain-backend.onrender.com/api/auth/admin/users'),
        axios.get('https://lost-and-gain-backend.onrender.com/api/auth/messages/admin/all'),
        axios.get('https://lost-and-gain-backend.onrender.com/api/materials/admin/claim-requests')
      ]);
  ...
  const handleDeletePost = async (id) => {
    ...
    try {
      ...
      await axios.delete('https://lost-and-gain-backend.onrender.com/api/materials/delete/' + id, {
  ...
  const handleBlock = async (id) => {
    ...
    try {
      await axios.put('https://lost-and-gain-backend.onrender.com/api/auth/admin/block/' + id);
      fetchAllData();
  ...
  const handleUnblock = async (id) => {
    ...
    try {
      await axios.put('https://lost-and-gain-backend.onrender.com/api/auth/admin/unblock/' + id);
      fetchAllData();
    } catch (err) { alert('Habaye ikosa!'); }
  };
  ...
  const handleReply = async (id) => {
    ...
    try {
      await axios.put('https://lost-and-gain-backend.onrender.com/api/auth/messages/reply/' + id, {
        reply: replyText[id]
      });
  ...
  const handleApprove = async (id) => {
    ...
    try {
      await axios.put('https://lost-and-gain-backend.onrender.com/api/materials/admin/claim-requests/approve/' + id);
      fetchAllData();
    } catch (err) { alert('Habaye ikosa!'); }
  };
  ...
  const handleReject = async (id) => {
    ...
    try {
      await axios.put('https://lost-and-gain-backend.onrender.com/api/materials/admin/claim-requests/reject/' + id);
      fetchAllData();
    } catch (err) { alert('Habaye ikosa!'); }
  };
                  ...
                  <div style={styles.grid}>
                    {filteredPosts.map((post) => (
                      <div key={post.id} style={{...styles.postCard, opacity: post.status === 'claimed' ? 0.7 : 1}}>
                        {post.photo ? (
                          <img src={'https://lost-and-gain-backend.onrender.com/uploads/' + post.photo} alt={post.material_name} style={styles.postImage} />
                        ) : (
                      ...
                      <div key={req.id} style={{
                        ...
                        <div style={styles.claimInfo}>
                          ...
                          <div style={styles.claimInfoRight}>
                            ...
                            <img
                              src={'https://lost-and-gain-backend.onrender.com/uploads/' + req.id_card_front}
                              alt="ID Front"
                              style={styles.idImage}
                            />
                            <p style={styles.idLabel}>Indangamuntu — Inyuma</p>
                            <img
                              src={'https://lost-and-gain-backend.onrender.com/uploads/' + req.id_card_back}
                              alt="ID Back"
                              style={styles.idImage}
                            />
                          </div>
