...
function Dashboard() {
  ...
  const fetchMyMessages = async () => {
    try {
      const res = await axios.get('https://lost-and-gain-backend.onrender.com/api/auth/messages/mine/' + encodeURIComponent(user.full_name));
  ...
  const fetchNotifications = async () => {
    try {
      const res = await axios.get('https://lost-and-gain-backend.onrender.com/api/auth/notifications/' + encodeURIComponent(user.full_name));
  ...
  const markAllRead = async () => {
    try {
      await axios.put('https://lost-and-gain-backend.onrender.com/api/auth/notifications/readall/' + encodeURIComponent(user.full_name));
      fetchNotifications();
    } catch (err) { console.log(err); }
  };
  ...
  const handlePost = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://lost-and-gain-backend.onrender.com/api/materials/announce', formData, {
        headers: { authorization: 'Bearer ' + token }
      });
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      await axios.post('https://lost-and-gain-backend.onrender.com/api/auth/messages/send', {
              ...
              <div style={styles.recentGrid}>
                {recentPosts.map(post => (
                  <div key={post.id} style={styles.recentCard}>
                    {post.photo ? (
                      <img src={'https://lost-and-gain-backend.onrender.com/uploads/' + post.photo} alt={post.material_name} style={styles.recentImg} />
                    ) : (
